...
{	
	...
	static int metodo; // dos heur�sticos implementados


	public static void main(String[] arg) 
	/* Los argumentos de ejecuci�n son       :  inicio  metodo
  		primer tablero por PosicionIncorrecta :    1       1
  		primer tablero por Manhattan          :    1       1
  		segundo tablero por PosicionIncorrecta:    2       1
  		segundo tablero por Manhattan         :    2       2
	 */ 
	{
...
/* Concretar la clase Nodo en el Problema 2 (Puzzle) */
{
	...
	public NodoP2(int inicio,TipoHeuristico tipoH) 
	{
		...
		if (inicio==1)
		{
			...
			tablero[0]=2;tablero[1]=3;tablero[2]=6;
			tablero[3]=1;tablero[4]=5;tablero[5]=4;
			tablero[6]=9;tablero[7]=7;tablero[8]=8;
		}
		else
		{
			// TABLERO 2 (NO TIENE SOLUCION)
			tablero[0]=9;tablero[1]=3;tablero[2]=7;
			tablero[3]=6;tablero[4]=5;tablero[5]=4;
			tablero[6]=8;tablero[7]=2;tablero[8]= 1;
		}

		if (podar()) System.out.println ("NO HAY SOLUCION");
		else System.out.println ("HAY SOLUCION");
	}
	...
	/* Heuristico 2: distancia Manhattan: suma para todas las
   		fichas de las distancias entre la posici�n actual y 
   		la posici�n  final  */   
	{
		int manhattan = 0;
		int x1, x2, y1, y2;
	...
	/* Si no se puede alcanzar la soluci�n devuelve true
   ...
   j<i and position(j)>position(i) */
	...
	/* genera los hijos nodo actual. Los hijos apuntan a su padre
   a trav�s idPadre */
	{
	...
	{
		if (valorHeuristico==0) return true;
		else return false;
	}
