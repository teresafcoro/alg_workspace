...
/**
 * Clase de utilidad, que genera para un vector los 3 órdenes iniciales
 * posibles: ordenado, inverso y aleatorio. También escribe el contenido de un
 * vector
 */
public abstract class Vector {
	...
	/**
	 * Este método inicializa el Vector con valores. También se puede utilizar para
	 * reinicializar con un nuevo tamaño de vector.
	 */
	...
	/**
	 * Intercambia los elementos de las posiciones i, j en el array a es O(1)
	 */
	...
	/**
	 * Método que ordena los elementos Se implementará un método específico de
	 * ordenación en cada subclase
	 */
	public abstract void ordenar();

	/**
	 * Devuelve el nombre del método de ordenación Se implementará en cada subclase
	 * 
	 * @return
	 */
